...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('ajl/kagrup/kagrup_edit/'.$row->id_kagrup)?>">
			<div class="form-row">
			...
			<br>
			  ...
			  <a href="<?php echo site_url('ajl/kagrup/view_kagrup');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
