...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('ajl/barang_keluar/barang_keluar_edit/'.$row->id_transaksi)?>">
			<div class="form-row">
			    <div class="form-group col-md-3">
				    <label>Kode Transaksi</label>
				    <input type="text" class="form-control" name="id_transaksi" value="<?php echo $row->id_transaksi?>" readonly="" autofocus autocomplete="off" >
			    </div>
			    <div class="form-group col-md-3">
				    <label>Tanggal</label>
				    <input type="date" class="form-control" name="tgl_keluar" onkeyup="this.value = this.value.toUpperCase()" required="" autocomplete="off" value="<?php echo $row->tgl_keluar?>">
			    </div>
			    <div class="form-group col-md-3">
				    <label>Barang</label>
<!-- 				    <input type="text" class="form-control" name="id_barang" autofocus autocomplete="off"> -->
			...
			<br>
			  ...
			  <a href="<?php echo site_url('ajl/barang_keluar/view_barang_keluar');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
