...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('ajl/fungsi/fungsi_edit/'.$row->id_fungsi)?>">
			<div class="form-row">
			    <div class="form-group col-md-4" required="" >
				    <label>ID</label>
				    <input type="text" class="form-control" name="id_fungsi" autocomplete="off" value="<?php echo $row->id_fungsi?>" readonly="">
			    </div>
				</div>
			<div class="form-row">
