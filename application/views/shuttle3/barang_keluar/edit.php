...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle3/barang_keluar/barang_keluar_edit/'.$row->id_transaksi)?>">
			<div class="form-row">
...
<!-- 				    <input type="text" class="form-control" name="id_barang" autofocus autocomplete="off"> -->
			...
			<div class="form-row">	
			    ...
			    <div class="form-group col-md-4" hidden="">
				    <label>Bagian</label>
				    <input type="text" class="form-control" name="id_bagian" value="Shtl3" autocomplete="off" value="<?php echo $row->id_bagian?>" >
			    </div>
			</div>
			<br>
