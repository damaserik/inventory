...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle3/mtc/mtc_edit/'.$row->id_mtc)?>">
			<div class="form-row">
			    <div class="form-group col-md-4" required="">
				    <label>ID Mtc</label>
				    <input type="text" class="form-control" name="id_mtc" required="" readonly="" autofocus autocomplete="off" value="<?php echo $row->id_mtc?>">
			    </div>
			    <div class="form-group col-md-4" required="">
				    <label>Nama</label>
			...
			<br>
			  ...
			  <a href="<?php echo site_url('shuttle3/mtc/view_mtc');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
