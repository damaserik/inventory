...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle3/jenis/jenis_edit/'.$row->id_jenis)?>">
			<div class="form-row">
			    <div class="form-group col-md-4" required="" >
				    <label>ID</label>
				    <input type="text" class="form-control" name="id_jenis" autocomplete="off" required=""value="<?php echo $row->id_jenis?>" readonly="">
			    </div>
				</div>
			<div class="form-row">
			...
			<br>
			  ...
			  <a href="<?php echo site_url('shuttle3/jenis/view_jenis');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
