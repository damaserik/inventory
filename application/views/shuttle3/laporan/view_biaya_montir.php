	...
	<?php 
		...
		// $tot_sisa=0;
				...
				<tr>
					...
					<td><?php echo number_format($row->LUSI_WARP_LINE,0,",",".");?></td>
					<td><?php echo number_format($row->PAKAN_WEFT_LINE,0,",",".");?></td>
					<td><?php echo number_format($row->MOTOR_UTAMA,0,",",".");?></td>					
					<td><?php echo number_format($row->MESIN_PALET,0,",",".");?></td>
					<td><?php echo number_format($row->BAUT_BAUT,0,",",".");?></td>			
					<td><?php echo number_format($row->BARANG_LAIN_LAIN,0,",",".");?></td>
