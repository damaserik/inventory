...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle2/kagrup/kagrup_edit/'.$row->id_kagrup)?>">
			<div class="form-row">
			    <div class="form-group col-md-4" required="">
				    <label>ID Kagrup</label>
				    <input type="text" class="form-control" name="id_kagrup" autofocus autocomplete="off" value="<?php echo $row->id_kagrup?>" readonly >
			    </div>
			    <div class="form-group col-md-4" required="">
				    <label>Nama</label>
			...
			<br>
			  ...
			  <a href="<?php echo site_url('shuttle2/kagrup/view_kagrup');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
