...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle2/barang_masuk/barang_masuk_edit/'.$row->id_transaksi)?>">
			<div class="form-row">
			    ...
			    <div class="form-group col-md-3">
				    <label>Tanggal</label>
				    <input type="date" class="form-control" name="tgl_masuk"  autocomplete="off" value="<?php echo $row->tgl_masuk?>">
			    </div>
			    <div class="form-group col-md-3">
				    <label>Barang</label>
			...
			<br>
			  ...
			  <a href="<?php echo site_url('shuttle2/barang_masuk/view_barang_masuk');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
