...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle2/barang/barang_edit/'.$row->id_barang)?>">
			<div class="form-row">
			    <div class="form-group col-md-4">
				    <label>Kode Barang</label>
				    <input type="text" class="form-control" name="id_barang" onkeyup="this.value = this.value.toUpperCase()" required="" readonly=""autofocus autocomplete="off" value="<?php echo $row->id_barang?>" >
			    </div>
			    <div class="form-group col-md-4">
			...
			<br>
			  ...
			  <a href="<?php echo site_url('shuttle2/barang/view_barang');?>" class="btn btn-secondary" onclick="return confirm('Yakin Cancel ?')">Cancel</a>
			</form>
			<?php endforeach ?>
		</div>
	</div>
