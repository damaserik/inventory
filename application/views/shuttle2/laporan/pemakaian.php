              ...
              <div class="row">
                <div class="col-md-12" style="font-size: 13px;">
                  <div class="row">
                      ...
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_pemakaian_cetak');?>" target="_blank">
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_view_pemakaian');?>" target="_blank">
            ...
            <h4>Laporan Biaya Montir</h4>
              ...
              <div class="row">
                <div class="col-md-12" style="font-size: 13px;">
                  <div class="row">
                      <div class="row" style="padding: 0px 0px 0px 33px;">
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_biaya_montir_cetak');?>" target="_blank">
                        <div class="form-group">                
                                <label>Zona</label>&ensp;
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_view_biaya_montir');?>" target="_blank">
                        <div class="form-group" hidden="">                
                                <label>Zona</label>&ensp;
