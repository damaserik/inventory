              ...
              <div class="row">
                <div class="col-md-12" style="font-size: 13px;">
                  <div class="row">
                      ...
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_stok_cetak');?>" target="_blank">
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_view_stok');?>" target="_blank">
            ...
            <h4>Laporan Stok + Harga</h4>
              ...
              <div class="row">
                <div class="col-md-12" style="font-size: 13px;">
                  <div class="row">
                      <div class="row" style="padding: 0px 0px 0px 33px;">
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_stok_harga_cetak');?>" target="_blank">
                        <div class="form-group">
                                <label for="expirationmonth">Bulan</label>&ensp;
                      ...
                      <!-- view laporan  -->
                      <form class="form-inline" method="POST" action="<?php echo site_url('shuttle2/laporan/laporan_view_stok_harga');?>" target="_blank">
                        <div class="form-group" hidden="">
                          <label for="expirationmonth">Bulan</label>&ensp;
