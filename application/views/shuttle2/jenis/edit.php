...
<div class="container">
	...
	<div class="card bg-ligh">
	  <div class="card-body">
        	...
        	<form method="POST" action="<?php echo site_url('shuttle2/jenis/jenis_edit/'.$row->id_jenis)?>">
			<div class="form-row">
			    <div class="form-group col-md-4" required="" >
				    <label>ID</label>
				    <input type="text" class="form-control" name="id_jenis" onkeyup="this.value = this.value.toUpperCase()" required="" autocomplete="off" value="<?php echo $row->id_jenis?>" readonly="">
			    </div>
				</div>
			<div class="form-row">
