...
class Laporan extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('M_laporan_shuttle2');
	}
	...
	public function laporan_stok()
	{
		...
		$c['content'] = $this->load->view('shuttle2/laporan/menu_stok', $h);
	...
	public function laporan_view_stok()
	{
		...
		$data['isi'] = $this->M_laporan_shuttle2->laporan_stok_view($bulan,$tahun);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('shuttle2/home_shuttle2', $data);
		$c['content'] = $this->load->view('shuttle2/laporan/view_stok', $h);
	}
	...
	{		
		$bulan =  $this->input->post('bulan');
		$tahun =  $this->input->post('tahun');
		$data['isi'] = $this->M_laporan_shuttle2->laporan_stok_harga($bulan,$tahun);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('shuttle2/home_shuttle2', $data);
		$c['content'] = $this->load->view('shuttle2/laporan/view_stok_harga', $h);
	}
	...
	public function laporan_stok_cetak()
	{
		...
		$bulan =  $this->input->post('bulan');
		$tahun =  $this->input->post('tahun');
		$data  =  $this->M_laporan_shuttle2->laporan_stok_view($bulan,$tahun);
		...
		public function laporan_stok_harga_cetak()
	{
		...
		$bulan =  $this->input->post('bulan');
		$tahun =  $this->input->post('tahun');
		$data  =  $this->M_laporan_shuttle2->laporan_stok_harga($bulan,$tahun);
	...
	{
		$h = $this->load->view('shuttle2/home_shuttle2');
		$c['content'] = $this->load->view('shuttle2/laporan/barang_masuk', $h);
	}
	...
	public function laporan_view_barang_masuk()
	{
		$bulan =  $this->input->post('bulan');
		$tahun =  $this->input->post('tahun');
		$data['isi'] = $this->M_laporan_shuttle2->laporan_barang_masuk_view($bulan, $tahun);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('shuttle2/home_shuttle2', $data);
		$c['content'] = $this->load->view('shuttle2/laporan/view_barang_masuk', $h);
	}
	public function laporan_barang_masuk_cetak()
	{
		...
		$bulan =  $this->input->post('bulan');
		$tahun =  $this->input->post('tahun');
		$data  =  $this->M_laporan_shuttle2->laporan_barang_masuk_view($bulan, $tahun);
  ...
  //      	$objPHPExcel->getActiveSheet()->getStyle('F'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
	...
	{
		$h = $this->load->view('shuttle2/home_shuttle2');
		$c['content'] = $this->load->view('shuttle2/laporan/pemakaian', $h);
	}
	...
	public function laporan_view_pemakaian()
	{
		...
		$data['isi'] = $this->M_laporan_shuttle2->laporan_pemakaian_view($bulan, $tahun, $zona);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('shuttle2/home_shuttle2', $data);
		$c['content'] = $this->load->view('shuttle2/laporan/view_pemakaian', $h);
	}
	...
	public function laporan_pemakaian_cetak()
	{
		...
		$tahun =  $this->input->post('tahun');
		$zona =  $this->input->post('zona');
		$data  =  $this->M_laporan_shuttle2->laporan_pemakaian_view($bulan, $tahun, $zona);
  ...
  //      	$objPHPExcel->getActiveSheet()->getStyle('F'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
	...
	public function laporan_view_biaya_montir()
	{
		...
		$tahun =  $this->input->post('tahun');
		$zona =  $this->input->post('zona');
		$data['isi'] = $this->M_laporan_shuttle2->laporan_biaya_montir($bulan, $tahun,$zona);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('shuttle2/home_shuttle2', $data);
		$c['content'] = $this->load->view('shuttle2/laporan/view_biaya_montir', $h);
	}
	...
	public function laporan_biaya_montir_cetak()
	{
		...
		$tahun =  $this->input->post('tahun');
		$zona =  $this->input->post('zona');
		$data  =  $this->M_laporan_shuttle2->laporan_biaya_montir($bulan, $tahun, $zona);
