...
class Laporan extends CI_Controller {
	...
	public function laporan_stok()
	{
		...
		$c['content'] = $this->load->view('ajl/laporan/menu_stok', $h);

	}

	public function laporan_view_stok()
	{
		$data['isi'] = $this->M_laporan_ajl->laporan_stok_view();
		$h = $this->load->view('ajl/home_ajl', $data);
		$c['content'] = $this->load->view('ajl/laporan/view_stok', $h);

	}

	public function laporan_view_stok_harga()
	{
		$data['isi'] = $this->M_laporan_ajl->laporan_stok_harga();
		$h = $this->load->view('ajl/home_ajl', $data);
		$c['content'] = $this->load->view('ajl/laporan/view_stok_harga', $h);
	...
	public function laporan_stok_cetak()
	{
		...
		$data  =  $this->M_laporan_ajl->laporan_stok_view();
		...
		public function laporan_stok_harga_cetak()
	{
		...
		$data  =  $this->M_laporan_ajl->laporan_stok_harga();
	...
	{
		$h = $this->load->view('ajl/home_ajl');
		$c['content'] = $this->load->view('ajl/laporan/barang_masuk', $h);
	}
	...
	public function laporan_view_barang_masuk()
	{
		...
		$data['isi'] = $this->M_laporan_ajl->laporan_barang_masuk_view($bulan, $tahun);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('ajl/home_ajl', $data);
		$c['content'] = $this->load->view('ajl/laporan/view_barang_masuk', $h);
	}
	public function laporan_barang_masuk_cetak()
	{
		...
		$bulan =  $this->input->post('bulan');
		$tahun =  $this->input->post('tahun');
		$data  =  $this->M_laporan_ajl->laporan_barang_masuk_view($bulan, $tahun);
  ...
  //      	$objPHPExcel->getActiveSheet()->getStyle('F'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
	...
	{
		$h = $this->load->view('ajl/home_ajl');
		$c['content'] = $this->load->view('ajl/laporan/pemakaian', $h);
	}
	...
	public function laporan_view_pemakaian()
	{
		...
		$data['isi'] = $this->M_laporan_ajl->laporan_pemakaian_view($bulan, $tahun, $zona);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('ajl/home_ajl', $data);
		$c['content'] = $this->load->view('ajl/laporan/view_pemakaian', $h);
	}
	...
	public function laporan_pemakaian_cetak()
	{
		...
		$tahun =  $this->input->post('tahun');
		$zona =  $this->input->post('zona');
		$data  =  $this->M_laporan_ajl->laporan_pemakaian_view($bulan, $tahun, $zona);
  ...
  //      	$objPHPExcel->getActiveSheet()->getStyle('F'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
	...
	public function laporan_view_biaya_montir()
	{
		...
		$tahun =  $this->input->post('tahun');
		$zona =  $this->input->post('zona');
		$data['isi'] = $this->M_laporan_ajl->laporan_biaya_montir($bulan, $tahun,$zona);
		$data['awal'] = $bulan;
	 	$data['akhir'] = $tahun;
		$h = $this->load->view('ajl/home_ajl', $data);
		$c['content'] = $this->load->view('ajl/laporan/view_biaya_montir', $h);
	}
	...
	public function laporan_biaya_montir_cetak()
	{
		...
		$tahun =  $this->input->post('tahun');
		$zona =  $this->input->post('zona');
		$data  =  $this->M_laporan_ajl->laporan_biaya_montir($bulan, $tahun, $zona);
		...
		$objPHPExcel->getSheet(0)->mergeCells('A1:I1');
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A'.$rowCount.':'.'I'.$rowCount)->getFill()->getStartColor()->setARGB('999999');

		//$objPHPExcel->getActiveSheet()->getStyle('G'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
  //      	$objPHPExcel->getActiveSheet()->getStyle('F'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
		// $objPHPExcel->getActiveSheet()->getStyle('H'.$rowCount)->getNumberFormat()->setFormatCode("_(Rp* #.##0_);_(Rp* (#.##0);_(Rp* "-"_);_(@_)");
        //  Border header
        $objPHPExcel->getActiveSheet()->getStyle('A'.$rowCount.':'.'I'.$rowCount)->applyFromArray(array('borders' => array('allborders' => array('style' => PHPExcel_Style_Border::BORDER_THIN))));        
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('H'.$rowCount, "PENOLONG");
		...
		foreach($data as $value){
		    ...
		    $objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, $value->nama_barang); 
		    $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, $value->LUSI); 
		    $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, $value->PAKAN); 
		    $objPHPExcel->getActiveSheet()->SetCellValue('H'.$rowCount, $value->PENOLONG); 
		    $objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount, $value->total); 
		    $rowCount++;
		}
		//  Border Data		
		$objPHPExcel->getActiveSheet()->getStyle('A4:I'.($rowCount-1))->applyFromArray(array('borders' => array('allborders' => array('style' => PHPExcel_Style_Border::BORDER_THIN))));
